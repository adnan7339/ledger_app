...
Aapki di hui image se `app/src/main/res/mipmap-*` folders mein icon files
generate ki gayi hain. Logo change karna ho to un PNG files ko replace kar
dein (har density folder mein `ic_launcher.png` aur `ic_launcher_round.png`).
